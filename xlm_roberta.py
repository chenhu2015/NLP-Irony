...
def compute_metrics(eval_pred):
   ...
   np.save("/home/kumarv/xuan0008/NLP_project/softmax/chinese_english_roberta.npy",logits)
...
# print(Chinese_test['train']['label'])
# print(English_test['train']['label'])
# exit()
