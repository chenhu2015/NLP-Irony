...
class GPTPromptTuningMixin:
    ...
    def initialize_soft_prompt(
        ...
        if initialize_from_vocab:
            ...
            # print(self.transformer.wte.weight[:n_tokens])
            # print(self.transformer.wte.weight[:n_tokens].shape)
            
            # print(init_prompt_value)
    ...
    def _cat_learned_embedding_to_input(self, input_ids) -> torch.Tensor:
        ...
        #print("First size is", inputs_embeds.size())
        # [batch_size, n_tokens, n_embd]
        learned_embeds = self.soft_prompt.weight.repeat(inputs_embeds.size(0), 1, 1)
        #print("Learned size is", learned_embeds.size())
        inputs_embeds = torch.cat([learned_embeds, inputs_embeds], dim=1)
        #print("Second size is", inputs_embeds.size())
    ...
    def forward(
        ...
        if input_ids is not None:
            ...
            #print("input_embeds size is", inputs_embeds.size())
        ...
        if attention_mask is not None:
            ...
            #print("attention_mask size is", attention_mask.size())
...
class GPT2PromptTuningLM(GPTPromptTuningMixin, GPT2ForSequenceClassification):
    def __init__(self, config):
        super().__init__(config)


class BertPromptTuningLM(BertPromptTuningMixin, BertForSequenceClassification):
    def __init__(self, config):
        super().__init__(config)
